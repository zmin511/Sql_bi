...
function createElement(id = "") {
  ...
  const element = {
    ...
    querySelectorAll(selector) {
      ...
      if (selector === "[data-relation-id][data-field-internal]") return descendants.filter(item => item.getAttribute("data-relation-id") !== null && item.getAttribute("data-field-internal") !== null);
      return [];
    }
  };
